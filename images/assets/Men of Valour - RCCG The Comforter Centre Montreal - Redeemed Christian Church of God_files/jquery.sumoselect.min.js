    ...
    if(!this.sumo&&a(this).is("select")){//already initialized
      var f=a.extend({},d,b,a(this).data());this.sumo={E:a(e),//the jquery object of original select element.
        ...
        setText:function setText(){var a=this;if(a.placeholder="",a.is_multi){var d=a.E.find(":checked").not(":disabled");//selected options.
          ...
          var c=a.select.find("input.HEMANT123");return c.length&&c.val(a.getSelStr()),b?a.caption.addClass("placeholder"):a.caption.removeClass("placeholder"),a.placeholder},isMobile:function isMobile(){// Adapted from https://www.detectmobilebrowsers.com
